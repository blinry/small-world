<script>
    ...
    const values = {
        ...
        bikes: {
            ...
            comment: "This number is a broad estimation from numbers collected between 1982-2000 and might be very outdated."
        },
        flightsPerYear: {
            value: 38.9e6,
            year: 2019,
...
<p>
    There are <Number {...values.cattleAlive} /> cattle, <Number {...values.sheepAlive} /> sheep,
    <Number {...values.goatAlive} /> goats, and <Number {...values.pigAlive} /> pigs alive right now.
</p>
<p>
